...
def main():
    ...
    for epoch in range(start_epoch, EPOCHS):
        ...
        # --- Trigger SentryCam Visualisation ---
    ...
    # Commenting the line below so that script can end properly without waiting for the plot window to be closed
    # plt.show()

    print("Training complete.")
    if patience_counter >= EARLY_STOPPING_PATIENCE:
        print(f"Best model (early stopped) saved at {best_model_path}")
    else:
